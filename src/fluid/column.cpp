  ...
  if(direction==IDIR) {
    ...
    Kokkos::parallel_for("ColumnX1", team_policy (nk*nj, Kokkos::AUTO),
      KOKKOS_LAMBDA (member_type team_member) {
        ...
        k += kb;
        Kokkos::parallel_scan(Kokkos::ThreadVectorRange<>(team_member,ib,ie),
    ...
    if(direction==JDIR) {
      ...
      Kokkos::parallel_for("ColumnX2", team_policy (nk*ni, Kokkos::AUTO),
        KOKKOS_LAMBDA (member_type team_member) {
          ...
          k += kb;
          Kokkos::parallel_scan(Kokkos::ThreadVectorRange<>(team_member,jb,je),
    ...
    if(direction==KDIR) {
      ...
      Kokkos::parallel_for("ColumnX2", team_policy (nj*ni, Kokkos::AUTO),
        KOKKOS_LAMBDA (member_type team_member) {
          ...
          j += jb;
          Kokkos::parallel_scan(Kokkos::ThreadVectorRange<>(team_member,kb,ke),
